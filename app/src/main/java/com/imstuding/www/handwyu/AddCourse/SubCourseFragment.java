...
public class SubCourseFragment extends Fragment {
    ...
    public void initFragment(View view){
        spinner_sub_kcmc= view.findViewById(R.id.spinner_sub_kcmc);
        fragment_sub_submit= view.findViewById(R.id.fragment_sub_submit);
        fragment_sub_cancel= view.findViewById(R.id.fragment_sub_cancel);
