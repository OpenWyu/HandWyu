...
public class BugFragment extends Fragment {
    ...
    public void initFragment(View view){
        edit_bug= view.findViewById(R.id.edit_bug);
        edit_phone_bug= view.findViewById(R.id.edit_contact_bug);
        btn_bug= view.findViewById(R.id.btn_bug);
        btn_join= view.findViewById(R.id.btn_join);
        btn_joinme= view.findViewById(R.id.btn_joinme);

        btn_joinme.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{
                    final String qqUrl = "mqqwpa://im/chat?chat_type=wpa&uin=1033381764&version=1";
