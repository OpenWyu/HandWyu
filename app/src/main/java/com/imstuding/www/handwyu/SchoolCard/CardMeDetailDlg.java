...
public class CardMeDetailDlg {
    ...
    private final CardInf m_CardInf;
    ...
    public void initDlg(View view){
        T_creattime= view.findViewById(R.id.card_me_time);
        T_kanum= view.findViewById(R.id.card_me_kanum);
        T_describeInfo= view.findViewById(R.id.card_me_dsc);
        T_phone= view.findViewById(R.id.card_me_phone);
        T_style= view.findViewById(R.id.card_me_type);
        ...
        if (Objects.equals(m_CardInf.getStyle(), "0")){
            T_style.setText("有人捡到");
        }else {
            T_style.setText("饭卡丢失");
        }

        btn_me_find= view.findViewById(R.id.btn_me_find);
