...
public class TableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        initFragment();
        mGestureDetector = new GestureDetector(myTouchListener);
        if (zc_flag){
    ...
    private void myPopMenu(){
        imageView_menu= view.findViewById(R.id.main_title_menu);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            ...
                            case R.id.menu_add_table:{
                                ...
                                intent.putExtra("JSESSIONID", MainActivity.getJsessionId());
    ...
    private void initFragment(){
        ...
        titleView = view.findViewById(R.id.title_table);
        imageView_menu= view.findViewById(R.id.main_title_menu);
        imageView_jiangtou= view.findViewById(R.id.main_title_jiantou);
        layout_zc= view.findViewById(R.id.layout_table_zc);

        weekTitle= view.findViewById(R.id.table_date);
        spinneryear= view.findViewById(R.id.year);
        spinner = view.findViewById(R.id.switchWeek);
        ...
        //////////////创建周数Spinner数据
        fillWeekDataList();
        spinnerAdapter = new ArrayAdapter<>(mContext, android.R.layout.simple_spinner_dropdown_item, dataList);
        ...
        while (cursor.moveToNext()){
            ...
            try{
                for (int aSection : section) {
                    if (aSection != 100)
                        contents[aSection][i_xq % 7] += kcmc + "@" + jxcdmc + "@" + xq + "@" + jcdm + "@" + zc + "@" + teaxms + "@" + jxbmc + "@" + sknrjj + "#";
                }
            }catch (Exception e){
                //什么也不做
            }
