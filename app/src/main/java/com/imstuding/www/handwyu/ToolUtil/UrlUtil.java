...
public class UrlUtil {
    ...
    //测试更新
    public static final String updateUrl  ="http://www.imstuding.com:8080/LostCard/IsUpdate.do";

    public static final String testAdUrl="http://www.imstuding.com:8080/LostCard/IsReplace.do";
    //有道api
    ...
    //蹭课
    public static final String auditUrl="http://202.192.240.29/xsgrkbcx!getQxkbDataList.action";

    public static final String getnotceUrl="http://www.imstuding.com:8080/LostCard/GetNotice.do";

    public static final String getKcdmUrl="http://202.192.240.29/xsgrkbcx!getKcxx.action";
