...
public class SchoolCardActivity extends AppCompatActivity {
    ...
    private void myPopMenu(){
        ...
        titleView= findViewById(R.id.title_schoolcard);
        imageView_menu.setVisibility(View.INVISIBLE);
        titleView.setTitleText("饭卡丢失");
    ...
    public void initActivity(){
        ...
        list_card= findViewById(R.id.school_card_list);
        ...
        btn_add= findViewById(R.id.school_card_add);
        btn_me= findViewById(R.id.school_card_me);
    ...
    public void initDlg(View view){
        E_kanum= view.findViewById(R.id.add_card_id);
        E_describeInfo= view.findViewById(R.id.add_card_dsc);
        E_phone= view.findViewById(R.id.add_card_phone);
        R_style= view.findViewById(R.id.add_card_radio);
        btn_submit= view.findViewById(R.id.add_card_submit);
        btn_cancel= view.findViewById(R.id.add_card_cancel);
