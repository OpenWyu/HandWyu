...
public class MyRemoteViewsFactoryBig implements RemoteViewsService.RemoteViewsFactory {
     ...
     * 构造函数
     */
    public MyRemoteViewsFactoryBig(Context context, Intent intent) {
        columnTotal=7;
        rowTotal=6;
        mContext = context;
    ...
    public RemoteViews getViewAt(int position) {
        rv = new RemoteViews(mContext.getPackageName(),
                R.layout.widget_grid_item_big);

        // 设置要显示的内容
        if( !getItem(position).equals("")) {
            rv.setTextColor(R.id.coure_text_big,Color.WHITE);
            rv.setTextViewText(R.id.coure_text_big, (CharSequence) getItem(position));
            //变换颜色
            ...
            switch( prand ) {
                case 0:
                    if (prand==rand){
                        rv.setTextColor(R.id.coure_text_big,Color.parseColor("#FFFFFF"));
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_red);
                    }else {
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_12);
                    }
                    break;
                case 1:
                    if (prand==rand){
                        ...
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_13);
                    }
                    break;
                case 2:
                    if (prand==rand){
                        ...
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_14);
                    }
                    break;
                case 3:
                    if (prand==rand){
                        ...
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_15);
                    }
                    break;
                case 4:
                    if (prand==rand){
                        ...
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_16);
                    }
                    break;
                case 5:
                    if (prand==rand){
                        ...
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_17);
                    }
                    break;
                case 6:
                    if (prand==rand){
                        ...
                        rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.bg_18);
                    }
                    break;
            }
            ...
            rv.setTextViewText(R.id.coure_text_big, "");
            rv.setInt(R.id.coure_text_big,"setBackgroundResource",R.drawable.grid_item_bg);
        }
        ...
        rv.setOnClickFillInIntent(R.id.coure_text_big, intent);
