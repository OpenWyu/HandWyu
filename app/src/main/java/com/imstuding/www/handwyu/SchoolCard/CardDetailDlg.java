...
public class CardDetailDlg {
    ...
    public void initDlg(View view){
        try{
            T_kanum= view.findViewById(R.id.card_kanum);
            T_creattime= view.findViewById(R.id.card_time);
            T_describeInfo= view.findViewById(R.id.card_dsc);
            T_phone= view.findViewById(R.id.card_phone);
            T_style= view.findViewById(R.id.card_type);
            ...
            if (Objects.equals(cardInf.getStyle(), "0")){
